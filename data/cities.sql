-- Generated by PySQLizer on 2019/08/20 00:12:39
-- Project reporistory: https://github.com/slafi/PySQLizer
-- Author: S. Lafi


-- -------------------------------------------------------
--	 These instructions build the table structure   
-- -------------------------------------------------------
USE `geocoordinates`;

DROP TABLE IF EXISTS `nacities`;

CREATE TABLE IF NOT EXISTS `nacities` 
...
-- ---------------------------------------------------------------
--	 This instruction inserts the data in the created table             
-- ---------------------------------------------------------------
INSERT INTO `nacities` (`LatD`, `LatM`, `LatS`, `NS`, `LonD`, `LonM`, `LonS`, `EW`, `City`, `State`) VALUES
